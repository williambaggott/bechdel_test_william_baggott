...
"%>%" allows you to move the data from one set to another, and can chain functions together. [Source.](https://stackoverflow.com/questions/24536154/what-does-mean-in-r)  
...
Summarise makes a new data frame in order to present the data you have collected. I found it by using ?summarise to look up the function in the help section.  
...
"Select" picks the variables in a data set to use for your code, instead of using all the data. Found this by using the search function in help to look up select and see what it does.  
...
Movies that pass the Bechdel Test seem to get a return on investment more often than movies that do not.
